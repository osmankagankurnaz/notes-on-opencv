...
for i in range(100000):
    ...
    cv.line(image, (np.int64(x1), np.int64(y1)), (np.int64(x2), np.int64(y2)), (b, g, r), 4, cv.LINE_8, 0)
    cv.rectangle(image, (np.int64(x1), np.int64(y1)), (np.int64(x2), np.int64(y2)), (b, g, r), 1, cv.LINE_8, 0)
    cv.imshow("image", image)
